# autogenerated by genmsg_py from CartesianArmActionActionFeedback.msg. Do not edit.
...
class CartesianArmActionActionFeedback(roslib.message.Message):
  _md5sum = "324588553b72e9da632f9db3864a4784"
  _type = "cart_interp/CartesianArmActionActionFeedback"
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','cart_interp/CartesianArmActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    if args or kwds:
      super(CartesianArmActionActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = cart_interp.msg.CartesianArmActionFeedback()
    else:
      self.header = roslib.msg._Header.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = cart_interp.msg.CartesianArmActionFeedback()
