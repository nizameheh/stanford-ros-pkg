# autogenerated by genmsg_py from CartesianArmActionResult.msg. Do not edit.
import roslib.message
import struct

import geometry_msgs.msg

class CartesianArmActionResult(roslib.message.Message):
  _md5sum = "1bbbe0b2099de4e34a85feb89694be87"
  _type = "cart_interp/CartesianArmActionResult"
...
"""
  ...
  def __init__(self, *args, **kwds):
    if args or kwds:
      super(CartesianArmActionResult, self).__init__(*args, **kwds)
