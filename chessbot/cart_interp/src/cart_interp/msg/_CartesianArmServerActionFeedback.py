# autogenerated by genmsg_py from CartesianArmServerActionFeedback.msg. Do not edit.
...
class CartesianArmServerActionFeedback(roslib.message.Message):
  _md5sum = "324588553b72e9da632f9db3864a4784"
  _type = "cart_interp/CartesianArmServerActionFeedback"
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','cart_interp/CartesianArmServerFeedback']
  ...
  def __init__(self, *args, **kwds):
    if args or kwds:
      super(CartesianArmServerActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = cart_interp.msg.CartesianArmServerFeedback()
    else:
      self.header = roslib.msg._Header.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = cart_interp.msg.CartesianArmServerFeedback()
