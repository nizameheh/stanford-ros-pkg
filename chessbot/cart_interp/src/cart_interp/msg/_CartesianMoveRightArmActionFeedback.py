# autogenerated by genmsg_py from CartesianMoveRightArmActionFeedback.msg. Do not edit.
...
class CartesianMoveRightArmActionFeedback(roslib.message.Message):
  _md5sum = "324588553b72e9da632f9db3864a4784"
  _type = "cart_interp/CartesianMoveRightArmActionFeedback"
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','cart_interp/CartesianMoveRightArmFeedback']
  ...
  def __init__(self, *args, **kwds):
    if args or kwds:
      super(CartesianMoveRightArmActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = cart_interp.msg.CartesianMoveRightArmFeedback()
    else:
      self.header = roslib.msg._Header.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = cart_interp.msg.CartesianMoveRightArmFeedback()
  ...
  def serialize(self, buff):
    try:
      ...
      buff.write(struct.pack('<7d', self.feedback.currentpoint.position.x, self.feedback.currentpoint.position.y, self.feedback.currentpoint.position.z, self.feedback.currentpoint.orientation.x, self.feedback.currentpoint.orientation.y, self.feedback.currentpoint.orientation.z, self.feedback.currentpoint.orientation.w))
  ...
  def deserialize(self, str):
    try:
      ...
      (self.feedback.currentpoint.position.x, self.feedback.currentpoint.position.y, self.feedback.currentpoint.position.z, self.feedback.currentpoint.orientation.x, self.feedback.currentpoint.orientation.y, self.feedback.currentpoint.orientation.z, self.feedback.currentpoint.orientation.w,) = struct.unpack('<7d',str[start:end])
      return self
