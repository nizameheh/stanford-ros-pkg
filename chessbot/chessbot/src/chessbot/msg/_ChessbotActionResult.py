# autogenerated by genmsg_py from ChessbotActionResult.msg. Do not edit.
...
class ChessbotActionResult(roslib.message.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "chessbot/ChessbotActionResult"
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','chessbot/ChessbotResult']
  ...
  def __init__(self, *args, **kwds):
    if args or kwds:
      super(ChessbotActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = chessbot.msg.ChessbotResult()
    else:
      self.header = roslib.msg._Header.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = chessbot.msg.ChessbotResult()
