# autogenerated by genmsg_py from CartesianArmServerActionResult.msg. Do not edit.
...
class CartesianArmServerActionResult(roslib.message.Message):
  _md5sum = "8796c700a48eebab32515e1356179491"
  _type = "cart_interp/CartesianArmServerActionResult"
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','cart_interp/CartesianArmServerResult']
  ...
  def __init__(self, *args, **kwds):
    if args or kwds:
      super(CartesianArmServerActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = cart_interp.msg.CartesianArmServerResult()
    else:
      self.header = roslib.msg._Header.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = cart_interp.msg.CartesianArmServerResult()
