# autogenerated by genmsg_py from CartesianArmServerResult.msg. Do not edit.
import roslib.message
import struct

import geometry_msgs.msg

class CartesianArmServerResult(roslib.message.Message):
  _md5sum = "1bbbe0b2099de4e34a85feb89694be87"
  _type = "cart_interp/CartesianArmServerResult"
...
"""
  ...
  def __init__(self, *args, **kwds):
    if args or kwds:
      super(CartesianArmServerResult, self).__init__(*args, **kwds)
