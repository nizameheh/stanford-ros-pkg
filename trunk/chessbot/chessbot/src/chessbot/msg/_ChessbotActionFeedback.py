# autogenerated by genmsg_py from ChessbotActionFeedback.msg. Do not edit.
...
class ChessbotActionFeedback(roslib.message.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "chessbot/ChessbotActionFeedback"
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','chessbot/ChessbotFeedback']
  ...
  def __init__(self, *args, **kwds):
    if args or kwds:
      super(ChessbotActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = chessbot.msg.ChessbotFeedback()
    else:
      self.header = roslib.msg._Header.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = chessbot.msg.ChessbotFeedback()
